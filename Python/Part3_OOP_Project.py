...
class Deck:
    ...
    def __init__(self) -> None:
        self.cards = [f'{rank}{suite}' for rank in RANKS for suite in SUITE]
    ...
    def splitting(self):
        ...
        self.first_half = self.cards[::2]
        self.second_half = self.cards[1::2]
...
class Player:
    ...
    def play_card(self):
        ...
        print(f"{self.name} has plased: {drawn_card}\n")
        return drawn_card
    
    def remove_war_cards(self):
        if len(self.hand.cards) < 3:
            war_cards = [card.pop(0) for card in self.hand.cards]
            return war_cards
        else:
            war_cards = [card.pop(0) for card in self.hand.cards[:3]]
            print(f"{self.name} has plased: {war_cards[0]}, {war_cards[1]}, {war_cards[2]}\n")
            return war_cards
